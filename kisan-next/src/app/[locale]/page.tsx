...
export default function Home() {
  ...
  const services = [
    { 
      title: navT("diseases"), 
      desc: "Identify & cure crop pests instantly", 
    ...
    { 
      ...
      desc: "Precise NPK dosing for your soil", 
    ...
    { 
      title: navT("weather"), 
      desc: "Accurate local village-level weather", 
  ...
  return (
    <div className="space-y-32 pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center ">
          <div className="space-y-10 animate-in slide-in-from-left duration-1000">
            ...
            <h1 className="text-6xl md:text-8xl font-black text-[#2e6b3b] tracking-tighter leading-[0.85]">
              किसान की हर <br />
              जरूरत का <br />
              <span className="text-[#8bc34a]">Digital साथी!</span>
            </h1>
          ...
          <div className="relative animate-in slide-in-from-right duration-1000">
            ...
            <div className="absolute top-10 -left-10 bg-white p-6 rounded-3xl shadow-2xl border border-border/50 max-w-[200px] hidden md:block">
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-sm font-black">Crop Health</p>
              </div>
              <p className="text-xs text-muted-foreground font-medium">Satellites monitoring your fields 24/7</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-16">
        <div className="max-w-7xl mx-auto px-4 flex flex-wrap justify-between items-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
      ...
      <section className="max-w-7xl mx-auto px-4 space-y-16">
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-black text-[#2e6b3b] tracking-tighter uppercase">Our Services</h2>
          <div className="h-1.5 w-24 bg-orange-400 mx-auto rounded-full" />
          <p className="text-xl text-muted-foreground font-medium">Empowering traditional knowledge with modern technology</p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 space-y-16 py-20">
        <div className="flex flex-col lg:flex-row items-end justify-between gap-8">
          <div className="space-y-4 max-w-2xl">
            <h2 className="text-5xl md:text-6xl font-black text-[#2e6b3b] tracking-tighter leading-none">CROP CARE & <br />DISEASE GUIDE</h2>
            <p className="text-xl text-muted-foreground font-medium">Select your crop to get expert medical advice, symptoms, and control measures.</p>
          </div>
          <Link href="/diseases">
            <Button variant="outline" className="h-14 px-8 rounded-2xl border-2 border-[#8bc34a] text-[#2e6b3b] font-black hover:bg-[#8bc34a]/10 group">
              View All Crops <ExternalLink className="w-5 h-5 ml-2 transition-transform group-hover:scale-110" />
            </Button>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div id="disease-details" className="lg:col-span-8 bg-white rounded-[60px] p-8 md:p-16 border border-slate-100 shadow-2xl min-h-[600px] flex flex-col">
            {selectedCrop ? (
              <div className="space-y-12 animate-in fade-in slide-in-from-right-10 duration-700">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 pb-10 border-b border-slate-100">
                  <div className="space-y-2">
                    <h3 className="text-4xl font-black text-[#2e6b3b] uppercase">{selectedCrop.name[locale as keyof TranslationMap]} CARE</h3>
                    <p className="text-muted-foreground font-bold flex items-center gap-2">
                      <LocateFixed className="w-4 h-4 text-[#8bc34a]" /> Best Season: {selectedCrop.season[locale as keyof TranslationMap]}
                    </p>
                  </div>
                    ...
                    <div className="space-y-10">
                      ...
                      <div className="p-10 rounded-[40px] bg-blue-50 border border-blue-100 relative overflow-hidden group">
                        ...
                        <h4 className="text-xl font-black text-blue-900 mb-6 flex items-center gap-3">
                          <CloudRain className="w-6 h-6" /> FAVORABLE CONDITIONS
                        </h4>
                    ...
                    <div className="space-y-10">
                      <div className="p-10 rounded-[40px] bg-[#2e6b3b] text-white shadow-2xl shadow-green-900/40 relative overflow-hidden group">
                        ...
                        <h4 className="text-xl font-black mb-8 flex items-center gap-3">
                          <ShieldCheck className="w-8 h-8 text-[#8bc34a]" /> PEST CONTROL (इलाज)
                        </h4>
                        <div className="space-y-8 relative z-10">
                          ...
                          <div className="space-y-4 pt-4 border-t border-white/20">
                            <p className="text-white/70 text-sm font-bold uppercase tracking-widest">General Precaution:</p>
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8 p-10 border-4 border-dashed border-slate-100 rounded-[50px]">
                ...
                <div className="space-y-2">
                  <h3 className="text-3xl font-black text-slate-400 uppercase">Crop Doctor is Ready</h3>
                  <p className="text-xl text-slate-400/80 font-bold">Select any crop on the left to start diagnosis</p>
                </div>
              </div>
            )}
          </div>
